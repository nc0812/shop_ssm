...
<head>
    ...
    <script type="text/javascript" src="js2/controller/brandController.js"></script>
    <script type="text/javascript" src="js2/service/brandService.js"></script>
</head>
<body class="hold-transition skin-red sidebar-mini" ng-app="pinyougou" ng-controller="brandController" ng-init="findByPage(1,10)">
  <!-- .box-body -->
