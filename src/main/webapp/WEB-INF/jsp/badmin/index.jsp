...
<head>
    ...
    <script type="text/javascript" src="js2/controller/indexController.js"></script>
    <script type="text/javascript" src="js2/service/loginService.js"></script>
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li>
                                            ...
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="img2/user2-160x160.jpg" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                                    系统消息
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="img2/user3-128x128.jpg" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                                    团队消息
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="img2/user4-128x128.jpg" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                                    Developers
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="img2/user2-160x160.jpg" class="user-image" alt="User Image">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="adminlogout" class="btn btn-default btn-flat">注销</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu"  >
                    ...
                    <li id="admin-index"><a href="home" target="iframe"><i class="fa fa-dashboard"></i> <span>首页</span></a></li>
