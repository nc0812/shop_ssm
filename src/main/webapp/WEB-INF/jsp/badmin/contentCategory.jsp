...
<head>
    ...
    <script type="text/javascript" src="js2/controller/contentCategoryController.js">  </script>
    
</head>
<body class="hold-transition skin-red sidebar-mini" ng-app="pinyougou" ng-controller="contentCategoryController" ng-init="findByPage(1,10)">
  <!-- .box-body -->
